import {defaultVectorSlotSize, busyBitSets, freeBitSets, newBusyBitset, newFreeBitset, bitsetStrToInt32Array, 
  prepareBitset, getCracVectorSlotSize, setAnd, setUnion, iterateCRACVector, getCRACFreeSlots} from "./vector";
...
export {
  ...
  getCracVectorSlotSize, setAnd, setUnion, iterateCRACVector, getCRACFreeSlots,
  // export from utils
